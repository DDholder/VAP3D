...
namespace VAP3D
{
    public interface IOffsetFactory
    {
        ...
        //
        // Summary:
        //     Creates a new Offset that will read from or write to the specified Offset for
        //     a specific type.
        //
        // Parameters:
        //   Address:
        ...
        //     for Programmer's document.
        //   Type:
        //     The offset's data type
        IOffset createOffsetForType(int Address, Type type);
        //
        // Summary:
        //     Creates a new Offset that will read from or write to the specified Offset for
        //     a specific type. Use writeOnly to signal that this offset will only ever
        //     be written to.
        //
        // Parameters:
        //   Address:
        ...
        //     The offset's data type
        //   writeOnly:
        //     True if this offset will only ever be written to
        IOffset createOffsetForType(int Address, Type type, bool writeOnly);
    }
}
